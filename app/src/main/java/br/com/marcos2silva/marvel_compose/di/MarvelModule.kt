...
import br.com.marcos2silva.marvel_compose.data.datasource.remote.MarvelRemoteDataSourceImpl
...
object MarvelModule {
    ...
    private val presentation = module {
        viewModel { CharacterViewModel(repository = get(), service = get()) }
    }

    private val domain = module {
        factory<MarvelRepository> { MarvelRepositoryImpl(dataSource = get(), service = get()) }
    }
